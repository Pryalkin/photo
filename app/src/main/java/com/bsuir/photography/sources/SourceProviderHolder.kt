package com.bsuir.photography.sources
...
import com.bsuir.photography.sources.backend.RetrofitSourcesProvider
...
//            .addInterceptor(createAuthorizationInterceptor(Singletons.appSettings))
    ...
    private fun createAuthorizationInterceptor(settings: AppSettings): Interceptor {
        return Interceptor { chain ->
            ...
            if (token != null) {
                newBuilder.addHeader("X-API-Key:", "3UjWA9QE6XLIl1W40eOKcyefCZtGsA9w")
            }
